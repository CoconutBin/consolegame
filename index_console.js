...
let character = new Item('o', Math.floor(Math.random() * worldWidth), Math.floor(Math.random() * worldHeight));
let treasure = new Item("X", Math.floor(Math.random() * worldWidth), Math.floor(Math.random() * worldHeight));
